...
export const useRealtime = () => {
  ...
  const handleApiChange = useCallback((data: Parameters<SocketEvents['api-change']>[0]) => {
  ...
  const handleApiHealthUpdate = useCallback((data: Parameters<SocketEvents['api-health-update']>[0]) => {
  ...
  const handleNotification = useCallback((data: Parameters<SocketEvents['notification']>[0]) => {
  ...
  const handleApiCheckComplete = useCallback((data: Parameters<SocketEvents['api-check-complete']>[0]) => {
