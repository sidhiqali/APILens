                    ...
                    <div className="relative">
                        <div className="flex items-center gap-3">
                            <span className="hidden text-right lg:block">
                                <span className="block text-sm font-medium text-gray-900">{user?.email || 'User'}</span>
                                <span className="block text-xs text-gray-600">{user?.email || 'user@example.com'}</span>
                            </span>
